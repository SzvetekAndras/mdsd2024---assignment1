...
/**
 * This is the item provider adapter for a {@link socialNetworkPackage.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SocialNetworkPackagePackage.Literals.PAGE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SocialNetworkPackagePackage.Literals.PAGE__POST);
			childrenFeatures.add(SocialNetworkPackagePackage.Literals.PAGE__EVENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Page.class)) {
			case SocialNetworkPackagePackage.PAGE__NAME:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SocialNetworkPackagePackage.Literals.PAGE__POST,
				 SocialNetworkPackageFactory.eINSTANCE.createPost()));

		newChildDescriptors.add
			(createChildParameter
				(SocialNetworkPackagePackage.Literals.PAGE__EVENT,
