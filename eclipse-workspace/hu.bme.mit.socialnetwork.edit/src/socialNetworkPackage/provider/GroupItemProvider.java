...
/**
 * This is the item provider adapter for a {@link socialNetworkPackage.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SocialNetworkPackagePackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SocialNetworkPackagePackage.Literals.GROUP__PERSON,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SocialNetworkPackagePackage.Literals.GROUP__EVENT);
			childrenFeatures.add(SocialNetworkPackagePackage.Literals.GROUP__POST);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Group.class)) {
			case SocialNetworkPackagePackage.GROUP__NAME:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SocialNetworkPackagePackage.Literals.GROUP__EVENT,
				 SocialNetworkPackageFactory.eINSTANCE.createEvent()));

		newChildDescriptors.add
			(createChildParameter
				(SocialNetworkPackagePackage.Literals.GROUP__POST,
