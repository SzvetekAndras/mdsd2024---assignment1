...
/**
 * This is the item provider adapter for a {@link socialNetworkPackage.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_likes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_likes_feature", "_UI_Comment_type"),
				 SocialNetworkPackagePackage.Literals.COMMENT__LIKES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Commenttext feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCommenttextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_commenttext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_commenttext_feature", "_UI_Comment_type"),
				 SocialNetworkPackagePackage.Literals.COMMENT__COMMENTTEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Comment)object).getCommenttext();
