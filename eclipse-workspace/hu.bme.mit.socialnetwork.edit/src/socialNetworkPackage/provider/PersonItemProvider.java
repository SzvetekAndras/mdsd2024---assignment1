...
/**
 * This is the item provider adapter for a {@link socialNetworkPackage.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_parent_feature", "_UI_Person_type"),
				 SocialNetworkPackagePackage.Literals.PERSON__PARENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SocialNetworkPackagePackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SocialNetworkPackagePackage.Literals.PERSON__GROUP,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SocialNetworkPackagePackage.Literals.PERSON__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SocialNetworkPackagePackage.Literals.PERSON__EMAIL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SocialNetworkPackagePackage.Literals.PERSON__POSTS);
			childrenFeatures.add(SocialNetworkPackagePackage.Literals.PERSON__COMMENT);
			childrenFeatures.add(SocialNetworkPackagePackage.Literals.PERSON__PAGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SocialNetworkPackagePackage.Literals.PERSON__POSTS,
				 SocialNetworkPackageFactory.eINSTANCE.createPost()));

		newChildDescriptors.add
			(createChildParameter
				(SocialNetworkPackagePackage.Literals.PERSON__COMMENT,
				 SocialNetworkPackageFactory.eINSTANCE.createComment()));

		newChildDescriptors.add
			(createChildParameter
				(SocialNetworkPackagePackage.Literals.PERSON__PAGE,
				 SocialNetworkPackageFactory.eINSTANCE.createPage()));
	}
